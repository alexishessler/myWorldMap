...
import IconPerso from './shield-me.png';
import IconOthers from './shield-others.png';
...
class App extends Component {
  ...
  formIsValid = () => {
    ...
    const result = Joi.validate(userMessage, messageJoiSchema);
  ...
  render() {
    ...
    // var markersList = this.state.messages.map(message => {
    //   return(<p>toto</p>)
    // });
    var markersList = this.state.messages.map((message, index) => {
      return(
        <Marker
          key={index}
